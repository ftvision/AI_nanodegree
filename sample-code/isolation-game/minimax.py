...
def _minimax_decision(gameState):
    ...
    Algo:
         The minimax() function should loop over the legal moves
         from the current state and return the move that has the
         highest score according to the min_value() helper function.
    """
